...
void TextManager::readFile(char* fileName) {
...
int TextManager::getFileLines(char* fileName) {
	std::ifstream myFile(fileName, std::ios::binary);
...
const char* TextManager::getLine(int atRow) {
	return (const char*) this->sourceLines[atRow];
}

void TextManager::changeLine(int atRow) {
	// some code to change the line
}

void TextManager::deleteLine(int) {

}

void TextManager::writeFile(char* currFileName) {
